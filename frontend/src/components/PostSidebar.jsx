      ...
      <nav className="flex-1 space-y-2">
        <Link
          ...
          className={`flex items-center p-3 rounded-lg transition-colors group ${
            isActive('/post/users') ? 'bg-blue-50 text-blue-600' : 'hover:bg-blue-50 hover:text-blue-600'
          }`}
        >
          <FaUsers className={`mr-3 ${
            isActive('/post/users') ? 'text-blue-600' : 'text-blue-500 group-hover:text-blue-600'
          }`} />
        ...
        <Link
          to="/post/attandance"
          className={`flex items-center p-3 rounded-lg transition-colors group ${
            isActive('/post/attandance') ? 'bg-blue-50 text-blue-600' : 'hover:bg-blue-50 hover:text-blue-600'
          }`}
        >
          <FaBuildingCircleCheck className={`mr-3 ${
            isActive('/post/attandance') ? 'text-blue-600' : 'text-blue-500 group-hover:text-blue-600'
          }`} />
        ...
        <Link
          to="/manitor"
          className={`flex items-center p-3 rounded-lg transition-colors group ${
            isActive('/manitor') ? 'bg-blue-50 text-blue-600' : 'hover:bg-blue-50 hover:text-blue-600'
          }`}
        >
          <FaBuildingCircleCheck className={`mr-3 ${
            isActive('/manitor') ? 'text-blue-600' : 'text-blue-500 group-hover:text-blue-600'
          }`} />
